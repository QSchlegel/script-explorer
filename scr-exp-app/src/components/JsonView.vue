<template>
    ...
    <div class="q-mt-sm q-mb-xs col text-center" v-if='props.data.type == "sig"' style="word-wrap:break-word">
        {{ "Signed by: "+ props.data.keyHash + " 🗝"}}
    </div>
    <div class="q-mt-sm q-mb-xs col text-center" v-if='props.data.type == "before"'>{{ "Before Slot: " + props.data.slot + " 🕰" }}</div>
    <div class="q-mt-sm q-mb-xs col text-center" v-if='props.data.type == "after"'>{{ "After Slot: " + props.data.slot + " 🕰" }}</div>
