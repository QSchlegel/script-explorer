<template>
    <nav
        ...
        <div class="container flex flex-wrap items-center justify-between">
            <a class="text-gray-500 hover:text-gray-900 dark:hover:text-white" data-drawer-target="drawer-list"
                data-drawer-show="drawer-list" data-drawer-hide="drawer-list">
            ...
            <a href="https://script-explorer.com/" class="flex items-center">
                <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Script-Explorer</span>
            </a>
            ...
            <div class="flex w-10 items-center justify-between">
                <span class="flex self-center w-3 h-3 bg-red-500 rounded-full" v-if="netStore.LoggedIn !== true" />
                <span class="flex self-center w-3 h-3 bg-green-500 rounded-full" v-if="netStore.LoggedIn === true" />
    ...
    <div id="drawer-list"
        class="fixed z-40 h-screen p-4 overflow-y-auto border-2 border bg-gray-100 w-80 dark:bg-gray-800 transition-transform left-0 top-0 -translate-x-full"
        tabindex="-1" aria-labelledby="drawer-left-label">
        <h5 id="drawer-left-label"
            class="inline-flex items-center mb-4 text-base font-semibold text-gray-500 dark:text-gray-400">
            Script-List
        </h5>
        <button type="button" data-drawer-hide="drawer-list" aria-controls="drawer-list"
