  ...
  <q-layout view="hHh LpR fFr">
    ...
    <q-header elevated class="bg-primary text-black">
      <q-toolbar>
        ...
        <q-input class="q-mb-xs" v-model="pID" v-if="!loggedIn" label="Project ID:" placeholder="Project ID"  />
        <q-btn flat round icon="login" v-if="!loggedIn" @click="store.setApi(pID); pID=''"/>
