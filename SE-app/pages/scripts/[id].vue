...
import PolicyView from '~~/components/core/scr/PolicyView.vue'
...
const loadScript = async () => {
    ...
    if (tmp !== []) {
        if (tmp.type === 'timelock') {
            ...
            if (await policy !== false) { plutusType.value = 'mint' }
        }
        else {
    ...
    <div class="w-96 md:w-3/4 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700 md:p-3">
        ...
        <div class="flex justify-between px-4 pt-4">
            ...
            <div class="flex p-1.5" data-popover-target="popover-scripthash" data-popover-placement="bottom">
                ...
                <svg aria-hidden="true" v-if="loaded !== true && netStore.LoggedIn === true"
        ...
        <div v-if="netStore.LoggedIn === true && scrType === 'timelock'" class=" px-3">
            <div class="inline-flex items-center justify-center w-full">
                ...
                <span
                    class="absolute px-1 text-xs md:text-md font-medium text-gray-900 -translate-x-1/2 bg-white left-1/2 dark:text-white dark:bg-gray-800">Required
                    Conditions: {{
        ...
        && plutusType === 'mint'" class="px-3">
            ...
            <PolicyView :policy="route.params.id" />
            <br />
